...
/// \brief LiquidCrystal library with PCF8574 SoftWire-I2C adapter.
///
...
/// through a PCF8574 I2C adapter. It uses the Softwire library from Steve Marple  for communication.
...
/// * 26.05.2022 constructor with SoftWire instance. Thanks to @Steve Marple.
...
class LiquidCrystal_PCF8574_SoftWire : public Print
{
public:
LiquidCrystal_PCF8574_SoftWire(uint8_t i2cAddr=0x27);
  // note:
  //
  ...
  LiquidCrystal_PCF8574_SoftWire(uint8_t i2cAddr, uint8_t rs, uint8_t enable,
    uint8_t d4, uint8_t d5, uint8_t d6, uint8_t d7, uint8_t backlight=255);
  LiquidCrystal_PCF8574_SoftWire(uint8_t i2cAddr, uint8_t rs, uint8_t rw, uint8_t enable,
    uint8_t d4, uint8_t d5, uint8_t d6, uint8_t d7, uint8_t backlight=255);

  // Functions from reference:

  void begin(uint8_t cols, uint8_t rows, SoftWire &wirePort); // &wirePort = Wire
